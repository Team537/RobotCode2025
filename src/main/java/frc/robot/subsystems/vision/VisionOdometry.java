 ...
 * <p>
 * This subsystem gathers pose data from multiple PhotonVision cameras, processes 
 * the data to determine the robot's position on the field, and feeds the results 
...
public class VisionOdometry extends SubsystemBase {
    ...
    private final List<PhotonVisionCamera> cameras = new ArrayList<>();
