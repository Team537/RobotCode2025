 ...
 * declared globally (i.e. public static).
...
public final class Constants {
     ...
     * {@code Constants} class.
     * This subclass contains all of the constants relating to how the robot is
     * manually controlled.
     * This includes things like the maximum boost mode speed, the driver controller
     * port, driver rotational offsets, etc.
     */
