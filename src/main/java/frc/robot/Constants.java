...
public final class Constants {
    ...
    public static class NarwhalConstants {
        ...
        public static class NarwhalIntakeOuttakeConstants {
            ...
            public static final double SLOW_OUTTAKE_MOTOR_PERCENT = 0.3;
        }
        ...
        public static class NarwhalWristConstants {
            ...
            public static Rotation2d INTAKE_ANGLE = Rotation2d.fromDegrees(30); // there's a lot of slop so this is going to be ~10 degreses over the actual position
            public static Rotation2d L1_OUTTAKE_ANGLE = Rotation2d.fromDegrees(245);   
