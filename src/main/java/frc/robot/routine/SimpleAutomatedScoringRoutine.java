...
public class SimpleAutomatedScoringRoutine implements IRoutine {
    ...
    public Command getCommandSet() {
        ...
        return new InstantCommand(() -> this.driveSubsystem.getPathfindingCommand(initalScoringPosition))
            .andThen(() -> this.upperAssembly.getCoralScoreCommand(ScoringHeight.L4))
