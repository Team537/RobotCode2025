...
/** 
 * A command that moves the manipulator into position for descoring algae
 */
public class NarwhalAlgaePreparePositionCommand extends Command{
    private final NarwhalElevator narwhalElevator;
    private final NarwhalWrist narwhalWrist;
    private final boolean isTopRow;

    /**
     * Creates a new NarwhalAlgaePreparePositionCommand.
     ...
     */
    public NarwhalAlgaePreparePositionCommand(NarwhalElevator narwhalElevator, NarwhalWrist narwhalWrist, boolean isTopRow){
    ...
    @Override
    public void execute(){
        // Move the elevator to the algae descore position, but do not press down on the algae
        narwhalElevator.goToAlgaeDescorePosition(isTopRow, false);
